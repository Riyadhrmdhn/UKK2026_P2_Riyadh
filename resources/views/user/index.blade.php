        ...
        <form action="{{ route('user.destroy', $user->id) }}" method="POST">
            ...
            <div class="modal-content border-0 shadow-lg rounded-3">
                <div class="modal-header border-0">
                    <h5 class="modal-title text-danger"><i class="fas fa-exclamation-triangle me-2"></i>Hapus User</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>

                <div class="modal-body text-center">
                    <p class="mb-4">Apakah Anda yakin ingin menghapus user <strong>{{ $user->name }}</strong>?</p>
                ...
                <div class="modal-footer justify-content-center border-0">
                    ...
                    <button type="submit" class="btn btn-danger btn-sm px-4 shadow-sm">Hapus</button>
                </div>
            </div>
        </form>
    </div>
