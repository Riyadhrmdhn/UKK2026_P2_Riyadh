...
<!-- Mirrored from prium.github.io/falcon/v3.26.0/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Apr 2026 08:45:23 GMT -->
                ...
                <li class="nav-item"><!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dashboard">
                  ...
                  <ul class="nav collapse show" id="dashboard">
                     <li class="nav-item"><a class="nav-link" href="dashboard/analytics.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Kelola User</span></div>
                      </a><!-- more inner pages--></li>
                    <li class="nav-item"><a class="nav-link" href="dashboard/crm.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Kelola Tarif</span></div>
                      </a><!-- more inner pages--></li>
                    <li class="nav-item"><a class="nav-link" href="dashboard/e-commerce.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Kelola Area</span></div>
                      </a><!-- more inner pages--></li>
                    <li class="nav-item"><a class="nav-link" href="dashboard/lms.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Log Aktivitas</span></div>
                      </a><!-- more inner pages--></li>
                  </ul>
                </li>
              </ul>
...
<!-- Mirrored from prium.github.io/falcon/v3.26.0/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Apr 2026 08:47:19 GMT -->
</html>